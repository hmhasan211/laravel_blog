                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $author->name }}</td>
                                <td><img src="{{ asset('storage/profile/'.$author->image) }}" width="100px" alt="{{ $author->name }}"></td>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-danger btn-xs waves-effect" type="button" onclick="deleteData({{$author->id}})">
                                        <i class="material-icons">delete</i>
                                    </button>
                                    <form id="delete-form-{{$author->id}}" method="post"  action="{{route('admin.authors.destroy',$author->id)}}" style="display: none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
